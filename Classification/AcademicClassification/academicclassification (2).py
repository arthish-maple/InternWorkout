...
plt.title("Distribution between Scholarship holder and Target ")
plt.show()
...
plt.title("Distribution between Gender and Target variable ")
plt.show()
...
plt.title("Distribution between Tution fee and Target variable ")
plt.show()
...
plt.title("Distribution between Education special needs and Target variable ")
plt.show()

#The age group above 20 has more  dropouts
plt.figure(figsize=(10,7))
sns.boxplot(data=academic_data, x="Age at enrollment", y="Target")
plt.title("Distribution between Age Enrollment and Target variable ")
plt.show()
...
plt.title("Distribution unemployment and Target variable ")
plt.show()
...
plt.title("Distribution between Inflation rate and Target variable ")
plt.show()

plt.figure(figsize=(10,7))
sns.boxplot(data=academic_data, x="GDP", y="Target")
plt.title("Distribution between GDP and Target variable ")
plt.show()
...
plt.title("Distribution between Debtors and Target variable ")
plt.show()
...
plt.title("Distribution between Displaced and Target variable ")
plt.show()
...
plt.title("Distribution between Attendence and Target variable ")
plt.show()
